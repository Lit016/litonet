translation = {
  ...
  "ah": "aー", "eh": "eー", "oh": "oー", "uh": "uー",
  "ra": "ら", "re": "れ", "ri":"り", "ro": "ろ", "ru": "る",
  "ar": "aー", "er": "aー", "ir": "aー", "or": "aー", "ur": "aー",
  "wa": "わ", "we": "うぇ", "wi":"うぃ", "wo": "うぉ", "wu": "う",
  "aw": "oー", "ew": "iぅー", "ow": "oう",
  "xa": "ざ", "xe": "ぜ", "xi":"くし", "xo": "くそ", "xu": "くす",
  "ax": "aっくす", "ex": "eっくす", "ix": "iっくす", "ox": "oっくす", "ux": "uっくす",
  /* 単子音 + 母音 */
  ...
  "tch": "っち",
  "ck":"っく", "ts":"つ",
  "ch": "ち", "gh": "", "ph": "ふ", "sh": "しゅ", "th": "す", "wh": "う",
  /* 母音単品 */
  "a": "あ", "e": "え", "i": "い", "o": "お", "u": "う",
  /* 子音単品 */
  "b": "ぶ", "c": "く", "d": "ど", "f": "ふ", "g": "ぐ", "h": "は", "j": "じゅ",
  "k": "く", "l": "る", "m": "む", "n": "ん", "p": "ぷ", "q": "く", "r": "る",
  "s": "す", "t": "と", "v": "ゔ", "w": "う", "x": "えっくす", "y": "い", "z": "ず",
  /* 記号 */
  "...": "…", "..": "‥",
  "'": "", ", ": "、", ". ": "。",
  ",": "、", ".": "。",
